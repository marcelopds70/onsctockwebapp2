package co.onstock.application.repository;

import co.onstock.application.Onsctockwebapp2App;
import co.onstock.application.config.Constants;
import co.onstock.application.config.audit.AuditEventConverter;
import co.onstock.application.domain.PersistentAuditEvent;
...
import static co.onstock.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
